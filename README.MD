...
Esta foi a primeira versão, focada em deixar a regra de negócio extremamente explícita utilizando o operador lógico && para definir o limite mínimo e máximo de cada nível. tentando escrever um pouco de código limpo, refiz algumas partes do meu código para exemplificar.
...
listaDeHerois.forEach(heroi => { const nome = heroi[0]; let xp = heroi[1]; let nivel;
